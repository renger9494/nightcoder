<template>
  <div class="cookies-popup" :class="{ 'cookies-popup_visible': isVisible }">
    ...
    <p class="cookies-popup__text">
      This site uses cookies. By using this site, you agree with the&nbsp;<a href="/privacy-policy" target="_blank"
        >Privacy Policy
      </a>
    </p>
    <a class="cookies-popup__close-button" href="#" @click="handleCloseButtonClick">
