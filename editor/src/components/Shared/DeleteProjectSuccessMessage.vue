  ...
  >
    <div class="delete-project-success-message__side">
      <div class="delete-project-success-message__circle">
        <svg class="delete-project-success-message__circle-svg" width="41" height="41">
          <circle
            class="delete-project-success-message__circle-progress delete-project-success-message__circle-progress_path"
            cx="20.5"
            cy="20.5"
            r="19"
          ></circle>
          <circle
            class="delete-project-success-message__circle-progress delete-project-success-message__circle-progress_fill"
            cx="20.5"
            cy="20.5"
            r="19"
      ...
      <span class="delete-project-success-message__text"> {{ modalType }} deleted </span>
    </div>
    <div class="delete-project-success-message__side"></div>
    <a class="delete-project-success-message__undo-button" href="#" @click="restore">
...
export default Vue.extend({
  ...
  computed: {
    ...mapState({
      restoreModalData: (state: any) => <RestoreModalData>state.project.restoreModalData
    }),
    modalType(): string {
  ...
  methods: {
    ...
    closeMessage() {
      ...
      if (this.restoreModalData.actionAfterDelete) this.restoreModalData.actionAfterDelete();
      this.$store.commit('project/changeRestoreModalData', null);
    }
  }
});
