<template>
  <div class="favicon">
    ...
    <div class="favicon__section">
      ...
      <description class="favicon__section-descr">Set your browser tab icon</description>
      <image-upload
    ...
    <upgrade-to-pro v-if="!isUserCanChangeFavicon">
      Your favicon is currently the Airtap logo.<br /><span>Upgrade to a&nbsp;Pro Plan</span>&nbsp;that includes a
      custom favicon.
    </upgrade-to-pro>
    <div class="favicon__actions" :class="!isUserCanChangeFavicon || isDisabledSaveChanges ? 'action-blocked' : ''">
      <button-component :tag="'button'" :onClick="saveChanges" :isDisabled="isSaving || isDisabledSaveChanges">
  ...
  computed: {
    ...
    isDefault(): boolean {
      if (
        ...
        (this.settings.faviconImage.path && this.settings.faviconImage.path.includes('Defaults/256.png'))
      )
        return true;
      else return false;
    }
