<template>
  <modal class="project-publish-modal" :isVisible="isVisible">
    <div class="project-publish-modal__inner">
      ...
      <img class="project-publish-modal__illustration" src="/img/modals/publishing-in-process-2.png" alt="" />
      ...
      <div class="project-publish-modal__persent">
        <span :style="`left: calc(${totalPersent}% - 17.5px);`">{{ totalPersent }}%</span>
      </div>
      ...
      <div class="project-publish-modal__progress">
        ...
        <span class="project-publish-modal__completed" :class="!nextStep ? 'active' : null">
...
export default {
  ...
  computed: {
    ...
    totalPersent() {
      let percent = Math.round(this.preprogress / 3.0303030303 + this.publishProgress / 1.49253731343);
