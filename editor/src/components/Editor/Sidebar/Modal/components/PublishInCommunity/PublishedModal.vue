<template>
  <div class="published">
    ...
    <div class="published__projects">
      ...
      <router-link class="published__upgrade-to-pro-button" to="/checkout/pro" data-text="Become a PRO">
        <svg-icon name="star-icon" width="13" height="13" color="#ffc557" />
        <span>B</span>
        <span>e</span>
        <span>c</span>
        <span>o</span>
  ...
  &__projects {
    ...
    &-image {
      ...
      &-background {
        ...
        height: 100%;
        position: absolute;
        background: linear-gradient(6.63deg, #f3f3f3 21.87%, rgba(255, 255, 255, 0) 78.55%);
      }
