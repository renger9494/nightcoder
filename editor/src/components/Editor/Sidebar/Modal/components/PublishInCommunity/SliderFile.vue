<template>
  <div class="sliderFile">
    <div class="sliderFile__preview">
      <div class="sliderFile__preview__poster">
        <div></div>
        <picture v-if="previewImage.fullPath">
          ...
          <img class="sliderFile__preview__previewImg" v-if="previewImage.fullPath" :src="previewImage.fullPath" />
        </picture>

        <img v-else :src="getPlaceholderUrl()" class="sliderFile__preview__previewImg" alt="" />
      </div>
    </div>
    <div class="slide">
