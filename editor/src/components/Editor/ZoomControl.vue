<template>
  <div
    ...
    tabindex="0"
    @keydown.esc.stop.prevent.exact="showZoomPopup = false"
  >
    <div
      v-tooltip="'Zoom/view options'"
      @click.exact="openZoomPopup"
      :class="{ active: showZoomPopup, focused: isFieldFocused }"
      class="zoom-control"
    >
