<template>
  <div class="publish-status-dotted" :class="className">
    ...
    <span v-if="status === CustomDomainState.DomainIsDisabled"
      >Custom domain is disabled</span
    >
    <span v-if="status === CustomDomainState.DomainIsntConnected"
      >Custom domain is not connected yet</span
    >
    ...
    className(): any {
      return {
        ...
        DomainIsntConnected: [
          ...
          CustomDomainState.DomainIsDisabled,
        ].includes(this.status),
        WebsiteIsPublished:
          this.status === CustomDomainState.WebsiteIsPublished,
      }
    },
  },
})
