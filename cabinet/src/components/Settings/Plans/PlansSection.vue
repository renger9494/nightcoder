  ...
  <div class="plans-section">
      ...
      <div class="plans-section__term-switch">
        <div class="plans-section__term-switch-inner">
          <span
            ...
            :class="{
              'plans-section__save_visible': activeTermName === TermNameType.Monthly,
            }"
          >
            Save 3 months
          </span>
          <span
            ...
            :class="{
              'plans-section__term-name_active': activeTermName === TermNameType.Annually,
            }"
          ...
          <span
            class="plans-section__term-name"
            :class="{
              'plans-section__term-name_active': activeTermName === TermNameType.Monthly,
            }"
    ...
    <div class="plans-section__plans-list">
      <div
        ...
        :class="{ 'plans-section__plan_active': activePlan === PlanCategory.Free }"
      >
        <h2 class="plans-section__plan-name">Free</h2>
        <span class="plans-section__plan-price">
          ${{ activeTermName === TermNameType.Annually ? annualPrices.free : monthlyPrices.free }}
        </span>
        <span class="plans-section__plan-duration">free forever</span>
        <p class="plans-section__plan-text">Start with basic features &amp; create your own site in minutes</p>
        ...
        <a class="plans-section__button" v-if="activePlan === PlanCategory.Free" href="#">
          Your current plan<check-icon />
        </a>
        <a class="plans-section__button" @click="openModal" v-if="activePlan !== PlanCategory.Free" href="#" data-text="Downgrade">
          <span>D</span>
          <span>o</span>
          <span>w</span>
          <span>n</span>
      ...
      <div
        ...
        :class="{ 'plans-section__plan_active': activePlan === PlanCategory.Starter }"
      >
        <h2 class="plans-section__plan-name">Starter</h2>
        <span class="plans-section__plan-price">
          ${{ activeTermName === TermNameType.Annually ? annualPrices.starter : monthlyPrices.starter }}
        </span>
        ...
        <ul class="plans-section__plan-features">
          ...
          <li
            class="plans-section__plan-features-item plans-section__plan-features-item_with-tooltip"
            v-if="activeTermName === TermNameType.Monthly"
          >
            <span>Airtap Branding</span>
            <p class="plans-section__tooltip">Airtap branding is absent only when purchasing an annual tariff</p>
          </li>
          <li
            class="plans-section__plan-features-item plans-section__plan-features-item_with-tooltip"
        ...
        <a class="plans-section__button" v-if="activePlan === PlanCategory.Starter" href="#">
          Your current plan<check-icon />
        </a>
        <router-link
        ...
        <a class="plans-section__button" @click="openModal" v-if="activePlan === PlanCategory.Pro" href="#" data-text="Downgrade">
          <span>D</span>
          <span>o</span>
          <span>w</span>
          <span>n</span>
      ...
      >
        ...
        <span class="plans-section__plan-price">
          ${{ activeTermName === TermNameType.Annually ? annualPrices.pro : monthlyPrices.pro }}
        </span>
        <span class="plans-section__plan-duration">per month</span>
        <p class="plans-section__plan-text">Start with basic features &amp; create your own site in minutes</p>
        <ul class="plans-section__plan-features">
        ...
        <a class="plans-section__button" v-if="activePlan === PlanCategory.Pro" href="#">
          Your current plan<check-icon />
        </a>
        <router-link
          class="plans-section__button"
...
import FeaturesTable from '@/components/Settings/Plans/FeaturesTable.vue'
import SwitchComponent from '@/components/Settings/Plans/Switch.vue'
