<template>
  <div class="projectPopup">
    <div class="projectPopup__preview">
      <div
        class="projectPopup__preview__block"
        :style="{
          'background-color':
            project.previewImage && project.previewImage.dominantColor
              ? project.previewImage.dominantColor
              : '#1B53C0',
        }"
      >
        <picture v-if="project.previewImage">
          ...
          <img
            class="projectPopup__preview__previewImg"
      ...
      <div class="projectPopup__preview__button">
        <div class="projectPopup__preview__public">
          <svg-icon
            class="projectPopup__preview__public__imgBlack"
            width="15"
            height="15"
            color="#000000"
            name="pages-icon"
    ...
    <div class="projectPopup__description">
      <span class="projectPopup__name">{{ project.name }}</span>
      <div class="projectPopup__likeAndView">
        <div>
          <svg-icon
            class="projectPopup__likeAndView__iconLike"
            width="12"
            height="11"
        ...
        <div>
          <svg-icon
            class="projectPopup__likeAndView__iconView"
            width="12"
            height="11"
            color="#dbdbdb"
            name="view"
    ...
    <div class="projectPopup__user-info">
      <div class="projectPopup__avatar">
      ...
      <p class="projectPopup__userName">
        by
