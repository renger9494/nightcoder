      ...
      <template v-if="isEnabledActionButton">
        ...
        <div class="paidContent__listDiv">
          ...
          <div
            ...
            @click="
              ;(isShowAllAction = !isShowAllAction),
          ...
          <div
            class="paidContent__list"
            v-if="isShowAllAction"
            v-click-outside="() => (isShowAllAction = false)"
          >
            <div
            ...
            >
              ...
              <div
                class="paidContent__itemList__label-pro"
                v-if="action == CommunityActionButtonType.File"
              >
        ...
        <div
          class="paidContent__link"
          v-if="selectedAction == CommunityActionButtonType.Link"
        >
          ...
          />
          <span
            v-if="inputErrorsLink"
            class="paidContent__link-input__error-text"
            aria-live="polite"
            >{{ inputErrorsLink }}</span
          >
        </div>
        ...
        <div class="paidContent__listDiv">
          ...
          <div
            ...
            class="paidContent__itemList"
            @click="
              ;(isShowAllIntegration = !isShowAllIntegration),
          ...
          >
            ...
            >
              <svg-icon width="24" height="24" :name="integration.icon" />
              <span class="paidContent__list__item__name">{{
                integration.name
              }}</span>
...
import SwitchComponent from '@/components/Modal/PublishInCommunity/Switch.vue'
import SliderFile from '@/components/Modal/PublishInCommunity/SliderFile.vue'
import FileInput from '@/components/Modal/PublishInCommunity/File/FileInput.vue'
import OnlyPro from '@/components/Modal/PublishInCommunity/OnlyPro.vue'
