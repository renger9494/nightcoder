  ...
  <div class="publishSettings">
    <div class="publishSettings__info">
      ...
      <input
        v-model="name"
        :maxlength="80"
        class="publishSettings__project-name"
      ...
      />
      <div v-if="tags">
       <div class="publishSettings__title-name" :class="{ error: isSubmitting && selectedTagsLength < 3 }">Tags (at least 3)</div>
        <div class="tags">
          <div
            v-for="(tag, index) in tags"
            :key="index"
            :class="{
              tag__active: tag.isActive,
            }"
            class="tag"
    ...
    <div class="publishSettings__project">
      ...
      <div class="publishSettings__project-wrap">
        <div class="publishSettings__preview">
          <div
            ...
            'background-color': imageLoading
              ? 'transparent'
              : previewImage && previewImage.dominantColor
          ...
          <div class="publishSettings__preview__button">
            <button
              class="publishSettings__preview__changePreview"
        ...
        <div class="publishSettings__user-info">
          ...
          <div
            class="publishSettings__userName__label-pro"
...
import CategoriesFilter from '@/components/Modal/PublishInCommunity/CategoriesFilter.vue'
import SelectedPages from '@/components/Modal/PublishInCommunity/SelectedPages.vue'
