<template>
  <div class="file-uploader">
    ...
    <div
      v-else-if="selectedFile.file || selectedFile.id"
      class="file-uploader__file"
    >
      <div class="file-uploader__file-preview">
        <span class="file-uploader__file-preview__name">{{
          selectedFile.name
        }}</span>
    ...
    >
      ...
      />
      <input
        class="file-uploader-wrapper__input"
        ref="file-input"
        type="file"
        @change="loadImage"
      />
      ...
      >
        <div class="file-uploader-wrapper__upload-file">
          <svg-icon
            ...
            folder="dashboard"
          />
          <span class="file-uploader-wrapper__upload-file__h1"
            >Drop file Here</span
          >
          <span
            :class="{
...
import DropProvider from '@/components/Modal/PublishInCommunity/File/DropProvider.vue'
