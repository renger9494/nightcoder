<template>
  <div class="forgotPassword__container">
    <div class="forgotPassword__item">
      <recover-an-account
        v-if="componentName === 'RecoverAnAccount'"
        @сhange="сhange('SentEmail')"
      />
      <sent-email v-else-if="componentName === 'SentEmail'" />
    </div>
    <user-feedback />
  </div>
</template>
...
import RecoverAnAccount from '@/components/Login/RecoverAnAccount.vue'
import SentEmail from '@/components/Login/SentEmail.vue'
...
export default Vue.extend({
  ...
  data() {
    return {
      componentName: 'RecoverAnAccount',
    }
  },
